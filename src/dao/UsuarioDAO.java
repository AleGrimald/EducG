...
public interface UsuarioDAO {
    ...
    /** @return Usuario con id/nombre/apellido/email/dni/telefono, o null si no existe. Sin filtrar activo. */
    Usuario obtenerUsuarioPorDni(long dni) throws SQLException;
