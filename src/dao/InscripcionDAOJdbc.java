...
public class InscripcionDAOJdbc implements InscripcionDAO {
    ...
    @Override
    public int altaInscripcion(String email, int cursoId) throws SQLException {
    ...
    @Override
    public void bajaInscripcion(String email, int cursoId) throws SQLException {
    ...
    public List<Inscripcion> listarPorUsuario(String email) throws SQLException {
        ...
        try (Connection conn = ConexionBD.obtenerConexion();
            ...
            try (ResultSet rs = cs.executeQuery()) {
                while (rs.next())
                    inscripciones.add(new Inscripcion(rs.getInt("curso_id"), rs.getString("titulo"), rs.getString("fecha_inscripcion")));
            }
        }
